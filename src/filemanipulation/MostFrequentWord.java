...
public class MostFrequentWord {
    public static void main(String[] args) {
        String s = "But then they were married (she felt awful about being pregnant before but\n" +
        ...
        System.out.println(mostFrequentWord(s));
    }

    private static String mostFrequentWord(String string) {
