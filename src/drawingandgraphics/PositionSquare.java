...
public class PositionSquare {
    ...
    public static void drawImage(Graphics graphics){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            // random start points
            int pointX = randomPosition;
            int pointY = randomPosition;

            // call function
            drawSquare(pointX, pointY, graphics);
        }

    }

    // Create a function that takes 3 parameters and draws one square
    public static void drawSquare (int pointX, int pointY, Graphics graphics) {
        int squareSize = 50;
        graphics.drawRect(pointX, pointY, squareSize, squareSize);
    }
